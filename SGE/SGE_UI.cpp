...
SGE_Button::SGE_Button( const SGE_Button & rhs )
{
	mpFont = new CFont;
	*mpFont = *rhs.mpFont;
	mpSprite = new CSprite;
	*mpSprite = *rhs.mpSprite;
	mpTextureOn = new CTexture;
	*mpTextureOn = *rhs.mpTextureOn;
	mpTextureOff = new CTexture;
	*mpTextureOff = *rhs.mpTextureOff;
	mText = rhs.mText;
}
